...
public class PageRankTest implements OperationTest {
    ...
    public void shouldSerialiseAndDeserialiseOperation() throws SerialisationException, JsonProcessingException {
        // Given
        final PageRank op = new PageRank();
        ...
        final PageRank deserialisedOp = serialiser.deserialise(json, PageRank.class);
